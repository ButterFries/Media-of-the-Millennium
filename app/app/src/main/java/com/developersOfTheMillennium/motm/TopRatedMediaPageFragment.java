...
public class TopRatedMediaPageFragment extends Fragment {
    ...
    public void onViewCreated(View v, Bundle savedInstance) {
        retrieveAndDisplay(movieButtons,"", "cinema", "getTopRatedMedia");
        retrieveAndDisplay(tvButtons, "", "tvseries", "getTopRatedMedia");
        retrieveAndDisplay(musicButtons, "", "music", "getTopRatedMedia");
        retrieveAndDisplay(videogameButtons, "", "videogame", "getTopRatedMedia");
        retrieveAndDisplay(novelButtons, "", "novel", "getTopRatedMedia");
    }
