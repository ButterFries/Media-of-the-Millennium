...
import com.developersOfTheMillennium.motm.CustomSearchAdapterList;
...
public class GetSearchResultsList extends AsyncTask<String, Void, Boolean> {
    ...
    public GetSearchResultsList(MainActivity a, SearchView s, MediaListPageFragment frag) {
        activity = a;
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result && search.equals(searchView.getQuery().toString())) {
            ...
            CustomSearchAdapterList adap = new CustomSearchAdapterList(activity, R.layout.search_row, cursor, columns, to, frag, searchView);
